    ...
    */
    ...
    public function getListadoEquipo(Request $request){
        ...
        foreach ($equipos as $item){
          ...
          $ver ='<a class="urlicon" title="Ver detalle" href="javascript:void(0)" style="font-size:20px" onclick="verdetalle('."'".$item->cod_equipo."'".')" ><i class="dripicons-preview"></i></a>&nbsp;
                <a class="urlicon" title="Reportar incidencia" href="javascript:void(0)" style="font-size:20px; color:#ffa91c" onclick="datosEquipo('."'".$item->cod_equipo."','".$item->dsc_equipo."'".')"><i class="dripicons-warning"></i></a>';
    ...
    public function getListadoEquipo2(Request $request){
      ...
      foreach ($equipos as $item){
        ...
        $ver ='<a class="urlicon" title="Ver detalle" href="javascript:void(0)" style="font-size:20px" onclick="verdetalle('."'".$item->cod_equipo."'".')" ><i class="dripicons-preview"></i> <a class="urlicon" title="Reportar incidencia" style="font-size:20px; color:#ffa91c" href="javascript:void(0)" onclick="datosEquipo('."'".$item->cod_equipo."','".$item->dsc_equipo."','".$item->cod_sede."'".')"><i class="dripicons-warning"></i></a>';
